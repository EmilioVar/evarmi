<form wire:submit.prevent='sendEmail' method="POST" class="space-y-8">
    ...
    <div class="flex items-center flex-col md:flex-row justify-center">
        ...
        <div class="{{ $emailSended ? 'block' : 'hidden' }} ml-5 p-2 text-[.9em] text-center">
